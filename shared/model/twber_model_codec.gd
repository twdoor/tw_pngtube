...
static func _is_layer_resource(resource: Variant) -> bool:
	return resource is TwberLayerResource


static func _is_animation_resource(resource: Variant) -> bool:
	return resource is TwberAnimationResource


static func _is_mesh_resource(resource: Variant) -> bool:
	return resource is TwberMeshResource
...
static func from_dictionary(data: Dictionary) -> Resource:
	...
	var model := TwberModelResource.new()
	model.format_version = int(data.get("format_version", TwberModelResource.FORMAT_VERSION))
...
static func _layer_from_dictionary(data: Dictionary) -> Resource:
	...
	layer.type = int(data.get("type", TwberLayerResource.LayerType.EMPTY)) as TwberLayerResource.LayerType
	...
	layer.clip_children = int(data.get("clip_children", CanvasItem.CLIP_CHILDREN_DISABLED)) as CanvasItem.ClipChildrenMode
